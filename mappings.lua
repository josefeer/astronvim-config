...
return {
  ...
  n = {
    ...
    ["<C-h>"] = { function() require("harpoon.ui").nav_file(1) end, desc = "Go to File 1 (Harpoon)" },
    ["<C-j>"] = { function() require("harpoon.ui").nav_file(2) end, desc = "Go to File 2 (Harpoon)" },
    ["<C-k>"] = { function() require("harpoon.ui").nav_file(3) end, desc = "Go to File 3 (Harpoon)" },
    ["<C-l>"] = { function() require("harpoon.ui").nav_file(4) end, desc = "Go to File 4 (Harpoon)" },
    -- Mine
